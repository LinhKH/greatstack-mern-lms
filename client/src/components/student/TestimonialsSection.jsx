  ...
  return (
    <div className="pb-14 px-8 md:px-0">
      ...
      <p className="md:text-base text-gray-500 mt-3">
        ...
        error reiciendis quasi, rem corrupti tenetur quia voluptatum dicta
        accusantium facere nesciunt itaque voluptatibus nobis unde quas
        repudiandae veniam officiis.
      </p>
